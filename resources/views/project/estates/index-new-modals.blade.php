...
@include('project.estates.Snapshots.snapshot')
<!-- /Snapshot of LifeSpot Owner's Estate -->
...
<!-- Modal: modalNewDocumentUpload -->
<div class="modal fade right" id="modalNewDocumentUpload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog xmodal-full-height modal-lg modal-right modal-notify modal-primary" role="document">
        <div class="modal-content" id="document_upload_modal_container">
        </div>
    </div>
</div>
<!-- Modal: modalNewDocumentUpload -->
...
<div id="documentShowModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
