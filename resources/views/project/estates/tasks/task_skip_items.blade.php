...
@endphp
@if ($task_items['task_skip_messages'])
    @foreach ($task_items['task_skip_messages'] as $task)
{{--
        @foreach ($task_item as $task)
--}}
            @if ($task)
                <div class="card skip_table_task_container task_container_set"
                        ...
                        <div class="row task_card">
                            ...
                            <!-- <button  type="button" class="close delete_task" >
                                ...
                                @if (isset($task['open_data']['class']))
                                    <a
                                            data-member-member-id="{{ isset($task['open_data']['member-member-id']) ? $task['open_data']['member-member-id'] : 0 }}"
                                            data-member-id="{{ isset($task['open_data']['member-id']) ? $task['open_data']['member-id'] : 0 }}"
