            ...
            <!-- Grid column -->
                <div class="col-lg-4 col-md-12 mb-lg-0 mb-5 member_overview_card"
                    ...
                    <div class="single-news mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-11 text-truncate pl-0 mb-3">
                                <a>Invitation Status</a>
                            </div>
                            <a class="get_invitation_status_to_member"><i class="fa fa-angle-double-right"></i></a>
                        </div>
                    ...
                    <div class="single-news mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="get_shared_documents_to_member"><i class="fa fa-angle-double-right"></i></a>
                        </div>
                        <div class="d-flex justify-content-between data_display"></div>
