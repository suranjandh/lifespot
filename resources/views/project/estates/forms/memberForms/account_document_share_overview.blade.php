...
$member_roles = $member->roles ;
    ...
    <!-- Grid column -->
    <div class="col-lg-4 col-md-12 mb-lg-0 mb-5 member_overview_card" data-member-id="{{$member->member_id}}">
        ...
        <div class="single-news mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-12">
                    ...
                    <!-- Badge -->
                    <a href="#!"><span class="badge" style="background-color: {{\App\Role::role_colors($roles_set_first_id)}};">{{$roles_set_first}}</span></a>
        ...
        <div class="single-news mb-3">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a class="get_shared_documents_to_member"><i class="fa fa-angle-double-right"></i></a>            </div>
