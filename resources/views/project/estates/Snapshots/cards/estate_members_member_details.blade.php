<tr><td>Address:</td><td class="member_info">{!! Helper::fill_empty_string($address) !!}</td><td></td></tr>
...
@if (trim($member->member_phone2) != '')
    <tr>
        <td>Phone:</td><td class="member_info">{!! Helper::fill_empty_string($member->member_phone2, 'phone') !!}</td>
        <td></td>
    </tr>
@endif
<tr><td>Birthday:</td><td class="member_info">{!! Helper::fill_empty_string($member->get_member_birth_day($member), 'date') !!}</td><td></td></tr>
