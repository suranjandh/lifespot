...
<div class="card" id="cardId-42">
    <div class="card-body">
        ...
        <div class="row mb-2">
            <div class="col-1"><img src="" class="dashboard-pic profile_image_img" alt="">
            </div>
            <div class="col-11 pl-5" xstyle="padding-left: 40px">
                <h5 class="col-10">Hey <span
                            class="bind_site_owner_name">{{auth()->user()->first_name}}</span>,
                    @php
                    ...
                    $msg = $diff->format("%a");
                    if ($msg === '0') {
                        echo "welcome to your LifeSpot dashboard. Checkout your tasks to help you get started. Invite friends! Let’s get started!";
                    } else {
                        echo "welcome back!  &nbsp;This is your dashboard. &nbsp;Look for important messages, news, and cool tips from LifeSpot, right here ... coming soon! Thanks for being a member for " . $msg @endphp@php echo $msg === '1' ? ' day.' : ' days.';
                    }
                    @endphp
        ...
        <div class="collapse show" id="user-dashboard">
            <div class="card-deck">
                ...
                <div class="card">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <!-- <p class="xdashboard-subtext dashboard-spanText xsnapshot-text xmt-3" data-toggle="modal"
                           data-target="#snapShotModal"><img class="mr-2" src="../img/icons8-parse_resumes.png" alt=""> Snapshot</p> -->
                        <p class=" dashboard-spanText xsnapshot-text xmt-3" data-toggle="modal"
                           data-target="#modalRelatedContent"><img class="mr-2"
                                                                   src="{{ Config::get('constants.PROJECT_IMAGE_URL') }}icons8-help.png" alt="">
                            Help Center</p>
                    </div>
                </div>
                <!--/.Panel-->
                ...
                <div class="card">
                    ...
                    <div class="card-body text-primary">
                        <a href="{{ route('kid_members') }}"><p class="dashboard-spanText">
                        ...
                        <!--
                                                <p onclick="documentFunction()" class="dashboard-spanText">

                                                    <img src="../img/icons8-documents.png" class="mr-2" alt="">
                                                    <span class="total_document_count dashboard-spanText">0</span>
                                                    <span class="dashboard-spanText">Documents</span>
                                                </p> -->
                        <a href="{{ route('kid_shared_info') }}">
                            <p class="dashboard-spanText">
                                ...
                                <span class="dashboard-spanText">Shared Info</span>
                            </p>
                        </a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <ul class="nav md-pills pills-secondary">
                        <li class="nav-item d-flex inline">
                            ...
                            <a class="my nav-link active ml-2" data-toggle="tab" href="#panel_task" role="tab">Current</a>
                        </li>
                        <li class="nav-item d-flex inline">
                            <span class="pl-3 dashboard-sm-count skipped_task_count">0</span>
                            <a class="nav-link ml-2" data-toggle="tab" href="#panel_task_skip" role="tab">Skipped</a>
                        </li>
                    </ul>
                    <!-- ================== -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <p class="heading activity-heading">{{auth()->user()->first_name}}'s Activity Logs
                </p>
...
<div class="modal fade right" id="CalendarEvents" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <!--Header-->
            <div class="modal-header">
                <p class="heading activity-heading">{{auth()->user()->first_name}}'s Calendar Events
                </p>
...
// include '../includes/footer-jsScripts.php';
@endphp
<style>
