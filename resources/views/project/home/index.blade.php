...
@section('content')
    ...
    <div class="navLoggedOut navAltTop">
        ...
        --}}
        @include('project.layouts.navLoggedOutV2')
    </div>
    <!-- <main></main> -->
    <style>
        .logo-text2 {
    ...
    <section class="z-depth-4" id="introPic">
        {{-- @php
         ...
         @endphp--}}
        @include('project.home.sections.AAAA1HomeTop')
    ...
    <div class="container mb-5" id="xscrollToWhatIsIt">
        ...
        <section class="my-5 pt-1">
            ...
            --}}
            @include('project.home.sections.whatIsLifeSpot')
        </section>
        ...
        <section class="my-5" id="why">
            ...
            @include('project.home.sections.why')
        </section>
        ...
        <section class="my-5" id="bestFeatures">
            ...
            --}}
            @include('project.home.sections.bestFeatures')
        </section>
        ...
        <section class="my-5" id="typeOfData">
            ...
            --}}
            @include('project.home.sections.typeOfData')
        </section>
        ...
        <section class="my-5 container" id="testimonials">
            ...
            --}}
            @include('project.home.sections.testimonials')
        </section>
        ...
        <section class="my-5 container" id="pricing">
            ...
            --}}
            @include('project.home.sections.pricing')
        </section>
        ...
        <section class="my-5 container" id="contactUs">
            ...
            --}}
            @include('project.home.sections.contactUs')
        </section>
        ...
        <section class="my-5 container" id="contactUs">
            ...
            --}}
            @include('project.home.sections.impressiveSecurity')
        </section>
